...
/**
 * Created by I on 6/06/2016.
 */
public class MainFragmentActivity extends ListActivity { private ProgressDialog progressDialog;
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    MainFragmentActivity.this, locationList,
